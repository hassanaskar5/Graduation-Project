...
void ADC_voidInit ( u8 ADC_CHANNEL_NUMBER)
{
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_1)
	{
		SET_BIT( ADMUX , 0 );
		CLEAR_BIT( ADMUX , 1 );
		CLEAR_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_2)
	{
		CLEAR_BIT( ADMUX , 0 );
		SET_BIT( ADMUX , 1 );
		CLEAR_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_3)
	{
		SET_BIT( ADMUX , 0 );
		SET_BIT( ADMUX , 1 );
		CLEAR_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_4)
	{
		CLEAR_BIT( ADMUX , 0 );
		CLEAR_BIT( ADMUX , 1 );
		SET_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_5)
	{
		SET_BIT( ADMUX , 0 );
		CLEAR_BIT( ADMUX , 1 );
		SET_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_6)
	{
		CLEAR_BIT( ADMUX , 0 );
		SET_BIT( ADMUX , 1 );
		SET_BIT( ADMUX , 2 );
	...
	else if(ADC_CHANNEL_NUMBER == DIO_u8_PIN_7)
	{
		SET_BIT( ADMUX , 0 );
		SET_BIT( ADMUX , 1 );
		SET_BIT( ADMUX , 2 );
